    ...
    return(
        <div>
            ...
            <ul>
                ...
                <li>Size: {bikeSize}</li>
                <li>Type: {bikeType}</li>
                <li>Price: <span style={{color:getColorFromPrice(bikePrice)}}>${bikePrice}</span></li>
            </ul>
            <button onClick={()=>{changeBikePrice(true)}}>Increase price</button> 
            <button onClick={()=>{changeBikePrice(false)}}>Decrease price</button>
        </div>
    );
}
